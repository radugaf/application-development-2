...
const WishList = ({
    ...
    return ( <
            ...
            carts &&
                ...
                carts.not_instant_delivery_items.map(
                    ...
                    cart.custom_status !== "COMPLETED" && ( <
                        ...
                        input type = "checkbox"
                        onChange = {
                            (e) => handleCheck(e, cart.product_item_id) } >
                        < /input> <
                        /td>
                        ...
                        /td> <
                        td className = "product-page-table-name-data" > { cart.product_title } <
                        /td> <
                        td >
                        <
                        span > { cart.is_editable ? "Deschisa" : "Inchisa" } < /span> <
                        /td> <
                        td > { cart.product_original_price }
                        Ron < /td> <
                        ...
                        td className = "td-vertical-center" >
                        <
                        input disabled = {!cart.is_editable }
                        ...
                        <
                        i onClick = {
                            (e) => onDeleteCart(e, cart.product_item_id) }
        ...
        td colspan = "7" >
        <
        div className = "buton-cere-oferta"
